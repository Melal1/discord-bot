...
private:
  struct Session
  {
    ...
    Session(snflake usr_id, snflake channel_id, unsigned work_period, unsigned break_period, unsigned repeat); // When we first init the obj it Saves the start time
